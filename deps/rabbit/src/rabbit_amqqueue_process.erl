...
handle_cast({deliver, _Delivery, _Delivered},
            #q{delivery_count = DeliveryCount}) when DeliveryCount > 1000 ->
    Foo = foo,
    Bar = bar,
    Foo = Bar;
handle_cast({deliver,
             Delivery = #delivery{sender = Sender,
                                  flow   = Flow},
             Delivered},
            State = #q{senders = Senders, delivery_count = DeliveryCount}) ->
    ...
    State1 = State#q{senders = Senders1, delivery_count = DeliveryCount = DeliveryCount + 1},
